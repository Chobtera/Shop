...
namespace VShop.Web.Controllers
{
    public class CartController : Controller
    {
        ...
        {
            Cart? cartVM = await GetCartByUser();
            return View(cartVM);
        }

        [HttpPost]
        public async Task<IActionResult> Checkout(Cart cartVM)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> ApplyCoupon(Cart cartVM)
        {
            if (ModelState.IsValid)
            {
        ...
        private async Task<Cart> GetCartByUser()
        {
