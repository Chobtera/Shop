    ...
    public static IEnumerable<Client> Clients =>
        new List<Client>
        {
               //cliente genérico
                ...
                {
                    ClientId = "client",
                    ClientSecrets = { new Secret("estava#ali".Sha256())},
                ...
                new Client
                {
                    ...
                    RedirectUris = {"https://localhost:5000/signin-oidc"},//login
                    PostLogoutRedirectUris = {"https://localhost:5000/signout-callback-oidc"},//logout
